    ...
    <ScrollView style={{}}>
      <View style={{ flex: 1, backgroundColor: '#fff' }}>
        <View style={{ position: 'relative' }}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1507089947368-19c1da9775ae?auto=format&fit=crop&w=400&q=80' }}
        ...
        <View style={{ padding: 20, marginTop: -50, paddingBottom: 5 }}>
          <Text style={{ fontWeight: 'bold', fontSize: 22 }}>Villa</Text>
          <Text style={{ color: '#888', marginBottom: 10 }}>Villa, Bangalore</Text>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 }}>
            <Text style={{ fontSize: 18, color: '#222', marginBottom: 10 }}>₹5500</Text>
        ...
        <View style={styles.cardContainer}>
          ...
          <View flexDirection="row">
            <Text style={{ textAlignVertical: 'center', marginLeft: 10, fontWeight: 600, fontSize: 17 }}>₹5500/month </Text>
