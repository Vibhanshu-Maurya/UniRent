    ...
    <ScrollView style={{}}>
      <View style={{ flex: 1, backgroundColor: '#fff' }}>
        <View style={{ position: 'relative' }}>
          <Image
            source={{ uri: 'https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?auto=format&fit=crop&w=400&q=80' }}
        ...
        <View style={{ padding: 20, marginTop: -50, paddingBottom: 5 }}>
          ...
          <Text style={{ color: '#888', marginBottom: 10 }}>Villa, Delhi</Text>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 }}>
            <Text style={{ fontSize: 18, color: '#222', marginBottom: 10 }}>₹4000</Text>
        ...
        <View style={styles.cardContainer}>
          ...
          <View flexDirection="row">
            <Text style={{ textAlignVertical: 'center', marginLeft: 10, fontWeight: 600, fontSize: 17 }}>₹4000/month </Text>
