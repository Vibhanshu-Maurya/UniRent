    ...
    <ScrollView style={{}}>
      <View style={{ flex: 1, backgroundColor: '#fff' }}>
        ...
        <View style={{ padding: 20, marginTop: -50, paddingBottom: 5 }}>
          <Text style={{ fontWeight: 'bold', fontSize: 22 }}>WorkSpace</Text>
          <Text style={{ color: '#888', marginBottom: 10 }}>WorkSpace, Pune</Text>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 }}>
            <Text style={{ fontSize: 18, color: '#222', marginBottom: 10 }}>₹4500</Text>
        ...
        <View style={styles.cardContainer}>
          ...
          <View flexDirection="row">
            <Text style={{ textAlignVertical: 'center', marginLeft: 10, fontWeight: 600, fontSize: 17 }}>₹4500/month </Text>
