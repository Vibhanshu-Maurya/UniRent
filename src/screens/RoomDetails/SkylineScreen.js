...
const royalVillaImages = [
  'https://t3.ftcdn.net/jpg/03/16/69/16/360_F_316691661_oSHK65TNnCY0uHLk6htlrQtEm5yOmBBQ.jpg',
    ...
    <ScrollView style={{}}>
      <View style={{ flex: 1, backgroundColor: '#fff' }}>
        <View style={{ position: 'relative' }}>
          <Image
            source={{ uri: 'https://t3.ftcdn.net/jpg/03/16/69/16/360_F_316691661_oSHK65TNnCY0uHLk6htlrQtEm5yOmBBQ.jpg' }}
        ...
        <View style={{ padding: 20, marginTop: -50, paddingBottom: 5 }}>
          <Text style={{ fontWeight: 'bold', fontSize: 22 }}>Office</Text>
          <Text style={{ color: '#888', marginBottom: 10 }}>Office, Channai</Text>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 }}>
            <Text style={{ fontSize: 18, color: '#222', marginBottom: 10 }}>₹6000</Text>
        ...
        <View style={styles.cardContainer}>
          ...
          <View flexDirection="row">
            <Text style={{ textAlignVertical: 'center', marginLeft: 10, fontWeight: 600, fontSize: 17 }}>₹6000/month </Text>
