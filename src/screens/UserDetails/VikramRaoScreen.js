...
const VikramRaoScreen = () => (
  <View style={styles.container}>
    ...
    <Text style={styles.bio}>
      Vikram Rao is recognized for his professionalism and high standards. Guests appreciate his prompt communication and the quality of his listings throughout India.
    </Text>
  </View>
);
...
export default VikramRaoScreen;
